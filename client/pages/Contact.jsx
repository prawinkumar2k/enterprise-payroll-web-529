                            ...
                            <form className="space-y-8">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        <label htmlFor="contact-firstname" className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">First Name</label>
                                        <input id="contact-firstname" type="text" className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 outline-none focus:ring-4 focus:ring-primary/10 transition-all font-bold" />
                                    </div>
                                    <div className="space-y-4">
                                        <label htmlFor="contact-lastname" className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Last Name</label>
                                        <input id="contact-lastname" type="text" className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 outline-none focus:ring-4 focus:ring-primary/10 transition-all font-bold" />
                                    </div>
                                </div>
                                <div className="space-y-4">
                                    <label htmlFor="contact-email" className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Email Address</label>
                                    <input id="contact-email" type="email" className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 outline-none focus:ring-4 focus:ring-primary/10 transition-all font-bold" />
                                </div>
                                <div className="space-y-4">
                                    <label htmlFor="contact-message" className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Message</label>
                                    <textarea id="contact-message" rows="4" className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 outline-none focus:ring-4 focus:ring-primary/10 transition-all font-bold"></textarea>
                                </div>
